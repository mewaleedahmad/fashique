...
const Home = () => {
  return (
    <section className="overflow-hidden ">
      ...
      <div className="flex flex-col text-3xl lg:text-4xl  items-center mt-14 py-4 justify-center">
        <h1>Trending Now</h1>
      <svg className="text-darkPrimary w-56 lg:w-64" viewBox="-347 -30.1947 694 96.19" stroke="currentColor" fill="none" role="presentation" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
