...
const Home = () => {
  return (
    <section className="overflow-hidden ">
      ...
      <div className="Desktop-Footer lg:flex hidden  gap-6 w-full border-t border-darkSecondary  mt-20 items-center py-20 justify-between text-darkPrimary bg-lightPrimary">
        <div className="flex w-[20%] flex-col gap-1 px-10">
        ...
        <h1 className="text-7xl font-extrabold  ">FASHIQUE</h1>
       <p className="w-[20%] text-sm px-6">The images used in this website is from <a className="underline underline-offset-2" href="https://outfitters.com.pk/" target="_blank" rel="noopener noreferrer" >Outfitters</a> and only used for learning purpose.</p>
      </div>
